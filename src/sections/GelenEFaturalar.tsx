...
export default function GelenEFaturalar() {
  ...
  const checkIsSaved = (f: any) => {
    return savedInvoices.includes(f.uuid) || (alisFaturalari || []).some((a: any) => a.faturaNo && (a.faturaNo === f.faturaNo || a.faturaNo === f.invoiceNumber));
  };
    ...
    <div className="space-y-6 max-w-7xl mx-auto p-4 sm:p-6 pb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">eLogo portalınıza gelen e-Faturaları görüntüleyin, filtreleyin ve kaydedin.</p>
        </div>
      ...
      <IntegrationImportPreviewModal 
        ...
        importApiUrl="/api/invoices/import-from-logo"
        onSuccess={() => {
