...
const dbPath = path.resolve(__dirname, 'personnel.db');
...
db.exec(`
  ...
  CREATE TABLE IF NOT EXISTS pointage (
    ...
    date DATE NOT NULL,
    status TEXT NOT NULL, -- 'Work', 'Weekend', 'Holiday', 'Annual Leave', 'Unpaid Leave', 'Sickness', etc.
  ...
  CREATE TABLE IF NOT EXISTS leaves (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    personnel_id INTEGER NOT NULL,
    type TEXT NOT NULL, -- 'Annual', 'Unpaid', 'Maternity', 'Sickness'
  ...
  CREATE TABLE IF NOT EXISTS documents (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    personnel_id INTEGER NOT NULL,
    type TEXT NOT NULL, -- 'ID', 'Address', 'Criminal Record', etc.
  ...
  CREATE TABLE IF NOT EXISTS requests (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    personnel_id INTEGER NOT NULL,
    type TEXT NOT NULL, -- 'Advance', 'Expense'
